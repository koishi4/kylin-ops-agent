...
const P = {
  ...
  // 主题切换：太阳（暗色时显示，点击转亮）/ 月牙（亮色时显示，点击转暗）
  sun: ['M12 7.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9z', 'M12 2.5v2.5', 'M12 19v2.5', 'M2.5 12H5', 'M19 12h2.5', 'M5.1 5.1l1.8 1.8', 'M17.1 17.1l1.8 1.8', 'M18.9 5.1l-1.8 1.8', 'M6.9 17.1l-1.8 1.8'],
  moon: ['M20 13.6A8 8 0 1 1 10.4 4a6.3 6.3 0 0 0 9.6 9.6z'],
}
